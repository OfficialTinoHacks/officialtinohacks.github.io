				...
				if (this.isHorizontal()) {
					...
					helpers.each(this.ticks, function(label, index) {
						...
						if (this.options.gridLines.show) {
							...
							// Draw the chart area
							if (this.options.gridLines.drawVerticalLines) {
		...
		initialize: function() {
			...
			helpers.extend(this, {
				_model: {
					...
					cornerRadius: 2,//options.tooltips.cornerRadius,
                    borderWidth:2,
                    borderColor:"black",
...
(function() {
	...
	var root = this,
		Chart = root.Chart,
		helpers = Chart.helpers;
	Chart.defaults.global.elements.line = {          //used for progress charts ******************
		tension: 0,
...
(function() {
	...
	Chart.defaults.global.elements.rectangle = {
		backgroundColor: Chart.defaults.global.defaultColor,
		borderWidth: 10,
		borderColor: "black"//Chart.defaults.global.defaultColor,
	};
